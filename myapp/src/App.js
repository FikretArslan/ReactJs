...
import BSDynamic from "./components/10-bootstrap/boostrap-dynamic";
...
import RandomImages from "./components/19-random-mages/random-images";
            ...
            <Row>
              ...
              <Col sm={10} className="p-5">
                <Routes>
                  ...
                  <Route path="/jsx-practise" element={<JsxPractise />} />
